...
/**
 * СЕЙЧАС НЕ ИСПОЛЬЗУЕТСЯ. Компонент оставлен на случай, если понадобится
 * кнопка аккаунта в шапке отдельной страницы.
 *
 * В приложении вход и регистрация живут в одном месте — секция «Аккаунт»
 * в «Личном кабинете» (ProfileScreen). Туда ведут аватар в TopBar на
 * десктопе и вкладка «Профиль» в нижнем баре на мобилке; оттуда же
 * открывается AuthModal из чата с репетитором и с лендинга.
 * Как плавающая кнопка в правом верхнем углу этот компонент накрывал
 * переключатель темы из TopBar и перехватывал его клики — поэтому из
 * layout.tsx он убран.
 *
